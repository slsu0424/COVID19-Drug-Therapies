IF NOT EXISTS (SELECT * FROM sys.objects O JOIN sys.schemas S ON O.schema_id = S.schema_id WHERE O.NAME = 'SDUD2018_1' AND O.TYPE = 'U' AND S.NAME = 'dbo')
CREATE TABLE dbo.SDUD2018_1
	(
...
--CREATE PROC bulk_load_SDUD2018
--AS
--BEGIN
COPY INTO dbo.SDUD2018_1
...
FROM 'https://sdudsynapseadls2.dfs.core.windows.net/sdudsynapsefilesystem/State_Drug_Utilization_Data_2018.csv'
WITH
(
	FILE_TYPE = 'CSV'
	,MAXERRORS = 0
...
SELECT TOP 100 * FROM dbo.SDUD2018_1
GO