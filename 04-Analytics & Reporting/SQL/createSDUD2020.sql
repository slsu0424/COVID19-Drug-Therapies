IF NOT EXISTS (SELECT * FROM sys.objects O JOIN sys.schemas S ON O.schema_id = S.schema_id WHERE O.NAME = 'SDUD2020' AND O.TYPE = 'U' AND S.NAME = 'dbo')
CREATE TABLE dbo.SDUD2020
	(
...
--CREATE PROC bulk_load_SDUD2020
--AS
--BEGIN
COPY INTO dbo.SDUD2020
...
FROM 'https://sdudsynapseadls2.dfs.core.windows.net/sdudsynapsefilesystem/State_Drug_Utilization_Data_2020.csv'
WITH
(
	FILE_TYPE = 'CSV'
	,MAXERRORS = 0
...
SELECT TOP 100 * FROM dbo.SDUD2020
GO